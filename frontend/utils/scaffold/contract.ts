...
// @ts-ignore - type-fest internal module
type MergeDeepRecord<A = any, B = any, C = any> = any;
import {
  Address,
  Block,
  GetEventArgs,
...
import deployedContractsData from "@/config/deployedContracts";
import externalContractsData from "@/config/externalContracts";
