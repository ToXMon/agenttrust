...
3. Set text records on subnames:
   - requester.agentrust.base.eth: agent.type=requester, capabilities=[...], endpoint=axl://localhost:9002, status=active
   - provider.agentrust.base.eth: agent.type=provider, capabilities=[...], endpoint=axl://localhost:9012, status=active
